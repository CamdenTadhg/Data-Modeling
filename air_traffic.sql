...
INSERT INTO countries (name) VALUES ('United States'), ('United Kingdom'), ('Mexico'), ('Morocco'), ('China'), ('Chile'), ('Japan'), ('France'), ('UAE'), ('Brazil');
...
INSERT INTO cities (name, country_id) VALUES ('Washington DC', 1), ('Seattle', 1), ('Tokyo', 7), ('London', 2), ('Los Angeles', 1), ('Las Vegas', 1), ('Mexico City', 3), ('Paris', 8), ('Casablanca', 4), ('Dubai', 9), ('Beijing', 5), ('New York', 1), ('Charlotte', 1), ('Cedar Rapids', 1), ('Chicago', 1), ('New Orleans', 1), ('Sao Paolo', 10), ('Santiago', 6);
...
INSERT INTO tickets
  (first_name, last_name, seat, departure, arrival, airline_id, from_city, to_city)
VALUES
